...
protected:
	...
	/** True while a level outliner refresh is in progress. */
	bool bRefreshingLevelOutliner;
};
...
public:
	...
	virtual bool CanSetWidgetMode(FWidget::EWidgetMode NewMode) const override { return true; }
