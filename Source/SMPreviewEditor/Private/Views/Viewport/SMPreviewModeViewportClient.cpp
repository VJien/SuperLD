...
FSMAdvancedPreviewScene::~FSMAdvancedPreviewScene()
{
	...
	FSMPreviewOutlinerUtils::CleanupLevelEditorOutlinerChecks(this);
}
...
void FSMAdvancedPreviewScene::CheckRefreshLevelOutliner()
{
	if (WorldContext)
	{
		...
		else
		{
			...
			bRefreshingLevelOutliner = false;
		}
	}
}
...
FWidget::EWidgetMode FSMPreviewModeViewportClient::GetWidgetMode() const
{
	if (IsActorSelected())
	{
