...
public:
	...
	/**
	 * Call from advance scene preview destructor to remove our checks for valid outliner worlds.
	 */
	static void CleanupLevelEditorOutlinerChecks(FSMAdvancedPreviewScene* PreviewOwner);
